...
const getOrderByEmailFromDb = (customarEmail) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield order_model_1.default.find({ email: customarEmail }).exec();
    return result;
});
